package com.bw.net_library;

import android.text.TextUtils;
import android.util.Log;


import com.bw.net_library.api.TokenApi;
import com.bw.net_library.common.Config;
import com.bw.net_library.protocol.TokenRespEntry;
import com.bw.net_library.retrofit.CustomGsonConverterFactory;
import com.bw.net_library.retrofit.LiveDataCallAdapterFactory;
...
public class RetrofitFactory {
    ...
    public Retrofit createRetrofit() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("")  //"BuildConfig"如果未生成，在设置->file types忽略文件删除build;
